...
- It logs images (with encoding and row-padding handling and optional downscaling), compressed
  images, joint states, and any other topic as text (type discovered at runtime, rendered as
  YAML through ROS introspection).
